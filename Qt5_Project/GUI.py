...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_open.setGeometry(QtCore.QRect(40, 340, 91, 41))
        self.btn_open.setObjectName("btn_open")
        self.btn_play = QtWidgets.QPushButton(self.centralwidget)
        self.btn_play.setGeometry(QtCore.QRect(180, 340, 75, 41))
        self.btn_play.setObjectName("btn_play")
        self.btn_stop = QtWidgets.QPushButton(self.centralwidget)
        self.btn_stop.setGeometry(QtCore.QRect(310, 340, 75, 41))
        self.btn_stop.setObjectName("btn_stop")
        self.sld_video = QtWidgets.QSlider(self.centralwidget)
        self.sld_video.setGeometry(QtCore.QRect(40, 310, 540, 20))
        ...
        self.lab_video.setGeometry(QtCore.QRect(590, 310, 54, 20))
        self.lab_video.setObjectName("lab_video")
        self.wgt_video = myVideoWidget(self.centralwidget)
        self.wgt_video.setGeometry(QtCore.QRect(40, 20, 611, 291))
